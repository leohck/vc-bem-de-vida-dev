...
export const NOT_RATED = {
    "label": TEXT_NOT_RATED, "value": VALUE_NOT_RATED,
    color: THEME_COLOR_NOT_RATED, "hex_color": HEX_COLOR_NOT_RATED,
    "disabled": false
};
export const VERY_LOW = {
    "label": TEXT_VERY_LOW, "value": VALUE_VERY_LOW,
    color: THEME_COLOR_VERY_LOW, "hex_color": HEX_COLOR_VERY_LOW,
    "disabled": false
};
export const LOW = {
    "label": TEXT_LOW, "value": VALUE_LOW,
    color: THEME_COLOR_LOW, "hex_color": HEX_COLOR_LOW,
    "disabled": false
};
export const REGULAR = {
    "label": TEXT_REGULAR, "value": VALUE_REGULAR,
    color: THEME_COLOR_REGULAR, "hex_color": HEX_COLOR_REGULAR,
    "disabled": false
};
export const HIGH = {
    "label": TEXT_HIGH, "value": VALUE_HIGH,
    color: THEME_COLOR_HIGH, "hex_color": HEX_COLOR_HIGH,
    "disabled": false
};
export const VERY_HIGH = {
    "label": TEXT_VERY_HIGH, "value": VALUE_VERY_HIGH,
    color: THEME_COLOR_VERY_HIGH, "hex_color": HEX_COLOR_VERY_HIGH,
    "disabled": false
};
